...
export const AboutSection: React.FC = () => {
  return (
    <section
      id="about-us"
      className="w-full bg-[#060e1e] text-white py-20 lg:py-28 border-b border-slate-800 relative overflow-hidden"
    >
      {/* Subtle CAD Architectural Blueprint Grid */}
      <div className="absolute inset-0 bg-[linear-gradient(to_right,#13223f_1px,transparent_1px),linear-gradient(to_bottom,#13223f_1px,transparent_1px)] bg-[size:32px_32px] opacity-25 pointer-events-none" />

      {/* Deep Executive Corporate Glow */}
      <div className="absolute top-1/4 -left-20 w-[480px] h-[480px] bg-primary/25 rounded-full blur-[140px] pointer-events-none" />
      <div className="absolute bottom-10 right-10 w-[420px] h-[420px] bg-secondary/15 rounded-full blur-[140px] pointer-events-none" />
      ...
      <div className="w-full max-w-[1536px] mx-auto px-4 sm:px-6 lg:px-12 xl:px-16 relative z-10">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-16 items-center">
          ...
          <div className="lg:col-span-6 flex flex-col justify-center">
            ...
            <p className="text-[14px] sm:text-[14.5px] text-slate-200 leading-relaxed mb-8 font-sans border-l-2 border-secondary pl-4 py-2.5 bg-slate-900/60 backdrop-blur-md rounded-r-lg border border-slate-800">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-3.5 mb-8">
              {/* Card 1: Aramco & SABIC */}
              <div className="p-4 bg-slate-900/60 backdrop-blur-md border border-slate-800 rounded-xl shadow-sm hover:border-slate-700 hover:bg-slate-850 hover:-translate-y-1 transition-all duration-300 flex flex-col group cursor-pointer">
                <div className="flex items-center gap-1.5 text-secondary mb-1.5">
                  ...
                  <span className="font-sans text-[10.5px] font-bold uppercase tracking-wider text-slate-400">
                    ACCURACY
                  </span>
                </div>
